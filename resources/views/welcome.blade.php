...
<div class="welcome">
	<div class="container flex flex--justify-space-between small--flex-wrap">
		<div class="two-thirds small--one-whole medium--one-whole welcome-note">
			<h1 class="flex flex--align-center no-margin">
			...
			<h2 class="h3 grey pronunciation">/switch/: The Songwriting Challenge</h2>
			<p class="large-text">
				<ol>
					<li>
		...
		<div class="one-third small--one-whole medium--one-whole">
			<h2>Log In</h2>
